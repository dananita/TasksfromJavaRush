...
public enum Column implements Columnable {
    ...
    /**
     * Возвращает имя колонки состоящее из 2х слов
     * @return columnName
     */
    @Override
    ...
    public void hide() {
        ...
        List<Column> resultColumn= getVisibleColumns();

        Column[] arrayColumn = new Column[resultColumn.size()];
        int countArray = 0;
        for (Column r:resultColumn) {
            arrayColumn[countArray]=r;
            countArray++;
        }
        configureColumns(arrayColumn);
    }
}
